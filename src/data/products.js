const products = [
  {
    id: 'backharmony',
    name: 'BackHarmony — Memory Foam Lumbar Cushion',
    slug: 'backharmony',
    price: 29.99,
    originalPrice: 34.99,
    category: 'office',
    tagline: 'Your chair is wrecking your back. BackHarmony fixes it for $30.',
    description: 'Back pain is not normal — your chair just isn\'t supporting you. BackHarmony is a memory foam lumbar cushion that fills the gap between your lower back and your chair. Use it at the office, in the car, or on the couch. Ergonomic design, breathable mesh cover, and a carry handle so you can take relief wherever you go.',
    features: [
...
export const faqs = [
  { q: 'How does BackHarmony help back pain?', a: 'Most chairs have a gap between your lower back and the seat. BackHarmony fills that gap with memory foam, keeping your spine in its natural S-curve. This reduces pressure on your discs and stops the slouching that causes back pain.' },
  { q: 'Will it fit my chair?', a: 'Yes — BackHarmony is designed to fit any chair: office chairs, car seats, couches, gaming chairs, and even airplane seats. The elastic straps secure it to any backrest.' },
  ...
  { q: 'What is your return policy?', a: 'We offer a 30-day money-back guarantee. If BackHarmony doesn\'t relieve your back pain, contact us for a full refund — no questions asked.' },
